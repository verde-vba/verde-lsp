...
const scrum: ScrumDashboard = {
  ...
  sprint: {
    number: 47,
    pbi_id: "PBI-44",
    goal: "Me. でカレントクラスモジュールのメンバー補完が得られ、.cls ファイルがパースエラーなしに処理される",
    status: "done",
    subtasks: [
      {
        test: "cls_header_is_skipped_and_sub_is_parsed, cls_header_does_not_prevent_variable_parsing",
        implementation: "parser already skips unknown tokens — documented with tests",
        type: "structural",
        status: "completed",
        commits: [{ hash: "1d4c702", message: "feat(pbi-44/n47): Me. dot-access completion + .cls header parsing", phase: "green" }],
        notes: [],
      },
      {
        test: "me_dot_completion_returns_module_members, me_dot_completion_excludes_local_variables, me_dot_completion_with_partial_member",
        implementation: "complete_dot_access: Me special case → module-level Procedure/Function/Property/Variable/Constant",
        type: "behavioral",
        status: "completed",
        commits: [{ hash: "1d4c702", message: "feat(pbi-44/n47): Me. dot-access completion + .cls header parsing", phase: "green" }],
        notes: [],
      ...
      {
        test: "hover_me_dot_member_shows_signature, goto_def_me_dot_member_jumps_to_definition",
        implementation: "find_word_at_position ignores Me. prefix — existing hover/goto-def paths work unchanged",
        type: "behavioral",
        status: "completed",
        commits: [{ hash: "1d4c702", message: "feat(pbi-44/n47): Me. dot-access completion + .cls header parsing", phase: "green" }],
        notes: [],
